...
impl Checker {
    ...
    fn register_builtins(&mut self) {
        let builtins = [
            ...
            ("str", Type::Func { params: vec![], ret: Box::new(Type::String) }),
            ("getenv", Type::Func { params: vec![Type::String], ret: Box::new(Type::String) }),
            ("system", Type::Func { params: vec![Type::String], ret: Box::new(Type::Int) }),
            ("pid", Type::Func { params: vec![], ret: Box::new(Type::Int) }),
            ("cwd", Type::Func { params: vec![], ret: Box::new(Type::String) }),
    ...
    pub fn resolve_type(&mut self, type_: &azurite_parser::ast::Type) -> Option<Type> {
        match type_ {
            ...
            azurite_parser::ast::Type::Array(elem, _) => {
                self.resolve_type(elem).map(|e| Type::Array(Box::new(e)))
            }
